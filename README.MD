...
| --- | --- |
| A playable Tic-Tac-Toe game built with `pygame`.<br>A small, readable environment for RL practice.<br>Tutorial scaffolding for Monte Carlo and SARSA.<br>Separate answer branches with completed implementations. | <img src="img/screen.png" alt="Gameplay preview" width="160" /> |
